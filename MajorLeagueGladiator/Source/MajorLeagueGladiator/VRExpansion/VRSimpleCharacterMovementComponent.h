...
UCLASS()
class MAJORLEAGUEGLADIATOR_API UVRSimpleCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
public:
...
class MAJORLEAGUEGLADIATOR_API FSavedMove_VRSimpleCharacter : public FSavedMove_Character
{
