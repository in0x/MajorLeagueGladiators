...
UCLASS()
class MAJORLEAGUEGLADIATOR_API UVRCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
public:
...
class MAJORLEAGUEGLADIATOR_API FSavedMove_VRCharacter : public FSavedMove_Character
{
