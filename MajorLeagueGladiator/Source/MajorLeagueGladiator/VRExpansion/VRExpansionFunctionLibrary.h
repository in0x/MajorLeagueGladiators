...
#include "../Plugins/Runtime/Steam/SteamVR/Source/SteamVR/Private/SteamVRPrivate.h" // Now in here since 4.15
...
class MAJORLEAGUEGLADIATOR_API UVRExpansionFunctionLibrary : public UActorComponent//UBlueprintFunctionLibrary
{
	//GENERATED_BODY()
