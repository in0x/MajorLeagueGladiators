...
USTRUCT()
struct PROTOTYPE_API FBPVRComponentPosRep
{
	GENERATED_BODY()
public:
	UPROPERTY()
...
struct PROTOTYPE_API FBPInteractionSettings
{
	GENERATED_BODY()
public:
...
USTRUCT(BlueprintType, Category = "VRExpansionLibrary")
struct PROTOTYPE_API FBPActorGripInformation
{
	GENERATED_BODY()
public:
...
USTRUCT(BlueprintType, Category = "VRExpansionLibrary")
struct PROTOTYPE_API FBPInterfaceProperties
{
	GENERATED_BODY()
public:
...
USTRUCT(BlueprintType, Category = "VRExpansionLibrary")
struct PROTOTYPE_API FBPActorPhysicsHandleInformation
{
	GENERATED_BODY()
public:
	UPROPERTY(BlueprintReadOnly)
