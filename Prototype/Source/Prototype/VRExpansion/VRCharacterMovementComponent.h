...
UCLASS()
class PROTOTYPE_API UVRCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
public:
...
class PROTOTYPE_API FSavedMove_VRCharacter : public FSavedMove_Character
{
...
class PROTOTYPE_API FNetworkPredictionData_Client_VRCharacter : public FNetworkPredictionData_Client_Character
{
public:
...
// Need this for capsule location replication?????
class PROTOTYPE_API FNetworkPredictionData_Server_VRCharacter : public FNetworkPredictionData_Server_Character
{
public:
